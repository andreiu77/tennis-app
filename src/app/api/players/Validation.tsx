...
export function validatePlayerData(body: any) {
    ...
    if (body.ranking && (typeof body.ranking !== "number" || body.ranking <= 0 || getAllPlayers().some(player => player.ranking === body.ranking))) {
