...
export function addPlayer(newPlayer: Omit<Player, "id">): Player {
    const player: Player = { id: nextId++, ...newPlayer, imageUrl: newPlayer.imageUrl || '/images/default-player.png' };
    players.push(player);
    return player;
}

export function updatePlayer(id: number, updatedData: Partial<Player>): Player | null {
